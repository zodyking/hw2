(()=>{var W={"--hw-bg":"#111111","--hw-surface":"#1c1c1c","--hw-surface-2":"#161616","--hw-elevated":"#282828","--hw-input-bg":"#282828","--hw-text":"#e1e1e1","--hw-muted":"#9b9b9b","--hw-disabled":"#6f6f6f","--hw-accent":"#03a9f4","--hw-accent-hover":"#29b6f6","--hw-accent-dim":"rgba(3, 169, 244, 0.15)","--hw-danger":"#f44336","--hw-warning":"#ff9800","--hw-success":"#4caf50","--hw-border":"#252525","--hw-border-strong":"#333333","--hw-hover":"#222222","--shadow-sm":"0 1px 2px rgba(0,0,0,0.3)","--shadow":"0 4px 6px rgba(0,0,0,0.4)","--shadow-md":"0 8px 16px rgba(0,0,0,0.5)","--shadow-lg":"0 16px 32px rgba(0,0,0,0.6)","--radius-sm":"6px","--radius-md":"10px","--radius-lg":"16px","--radius-xl":"20px","--radius-full":"9999px","--space-1":"4px","--space-2":"8px","--space-3":"12px","--space-4":"16px","--space-5":"24px","--space-6":"32px","--fs-xs":"11px","--fs-sm":"12px","--fs-body":"14px","--fs-md":"16px","--fs-lg":"20px","--fs-xl":"28px","--fs-2xl":"36px","--fs-hero":"clamp(64px, 18vw, 104px)","--ease":"cubic-bezier(0.4, 0, 0.2, 1)","--ease-in":"cubic-bezier(0.4, 0, 1, 1)","--ease-out":"cubic-bezier(0, 0, 0.2, 1)","--dur-fast":"150ms","--dur-normal":"250ms","--dur-slow":"400ms"},j={"--hw-bg":"#f5f5f5","--hw-surface":"#ffffff","--hw-surface-2":"#f0f0f0","--hw-elevated":"#e8e8e8","--hw-input-bg":"#ffffff","--hw-text":"#1a1a1a","--hw-muted":"#666666","--hw-disabled":"#999999","--hw-accent":"#0288d1","--hw-accent-hover":"#0277bd","--hw-accent-dim":"rgba(2, 136, 209, 0.12)","--hw-danger":"#d32f2f","--hw-warning":"#e65100","--hw-success":"#2e7d32","--hw-border":"#e0e0e0","--hw-border-strong":"#cccccc","--hw-hover":"#eeeeee","--shadow-sm":"0 1px 2px rgba(0,0,0,0.08)","--shadow":"0 4px 6px rgba(0,0,0,0.1)","--shadow-md":"0 8px 16px rgba(0,0,0,0.12)","--shadow-lg":"0 16px 32px rgba(0,0,0,0.15)"};function Y(){return{...W}}function G(){return{...j}}function O(n="dark",e={}){return{...n==="light"?G():Y(),...e}}function X(n,e){if(!(!n||!n.style)){for(let[a,t]of Object.entries(e))n.style.setProperty(a,t);n.setAttribute("data-hw-theme",e["--hw-bg"]==="#f5f5f5"?"light":"dark")}}function R(n,e,a={}){let t=O(e,a);return X(n,t),t}var f=class{constructor(e){this._hass=e,this._id=0,this._pending=new Map,this._subs=new Map,this._connected=!1,this._hass&&this._hass.connection&&(this._conn=this._hass.connection,this._connected=!0)}async call(e){if(!this._conn)throw new Error("WS connection not available");let a=++this._id;return new Promise((t,r)=>{this._pending.set(a,{resolve:t,reject:r}),this._conn.subscribeMessage(s=>this._handleResponse(a,s),{...e,id:a})})}_handleResponse(e,a){var r;let t=this._pending.get(e);t&&(this._pending.delete(e),a.success===!1?t.reject(new Error(((r=a.error)==null?void 0:r.message)||"WS error")):t.resolve(a.result))}async subscribe(e,a){if(!this._conn)return()=>{};let t=++this._id,r=await this._conn.subscribeMessage(a,{type:e,id:t});return this._subs.set(t,r),r}async command(e,a={}){return this.call({type:`home_weather/${e}`,...a})}async getConfig(){return this.command("get_config")}async setConfig(e){return this.command("set_config",{config:e})}async getWeather(){return this.command("get_weather")}async getHurricanes(){return this.command("get_hurricanes")}async getTornadoes(){return this.command("get_tornadoes")}async getEarthquakes(){return this.command("get_earthquakes")}async getLightning(){return this.command("get_lightning")}async getVolcanoes(){return this.command("get_volcanoes")}async getWildfires(){return this.command("get_wildfires")}async getAirQuality(){return this.command("get_air_quality")}async getTravelAdvisories(){return this.command("get_travel_advisories")}async getSpaceMap(){return this.command("get_space_map")}async getSolarWeather(){return this.command("get_solar_weather")}async getVersion(){return this.command("get_version")}isConnected(){return this._connected}};function B(n,e=200){let a=null,t=(...r)=>{a&&clearTimeout(a),a=setTimeout(()=>{a=null,n(...r)},e)};return t.cancel=()=>{a&&clearTimeout(a),a=null},t}function q(n,e){let a=window.matchMedia(n);e(a.matches);let t=r=>e(r.matches);return a.addEventListener("change",t),()=>a.removeEventListener("change",t)}function F(n,e){return n.querySelector(e)}function P(n){if(n)for(;n.firstChild;)n.removeChild(n.firstChild)}var g=class{constructor({data:e}){this._data=e}render(){var h,d,p,u,D,A;let e=document.createElement("div");e.className="atmosphere-card";let t=(this._data||{}).current||{},r=(h=t.temperature)!=null?h:"--",s=t.condition||"Unknown",i=(d=t.apparent_temperature)!=null?d:"--",o=(p=t.wind_speed)!=null?p:"--",c=(u=t.wind_bearing)!=null?u:"",l=(D=t.humidity)!=null?D:"--",m=(A=t.uv_index)!=null?A:"--";return e.innerHTML=`
    ...
    `,e}};var J=["New Moon","Waxing Crescent","First Quarter","Waxing Gibbous","Full Moon","Waning Gibbous","Last Quarter","Waning Crescent"];function x(n){let e=n instanceof Date?n:new Date(n),a=e.getHours(),t=e.getMinutes().toString().padStart(2,"0"),r=a>=12?"PM":"AM";return a=a%12||12,`${a}:${t} ${r}`}function I(n=new Date){let e=n.getFullYear(),a=n.getMonth()+1,t=n.getDate(),r=0,s=0,i=0,o=0;a<3?(r=e-1,s=a+12):(r=e,s=a),i=Math.floor(365.25*(r+4716))+Math.floor(30.6001*(s+1))+t-1524.5,o=(i-24515501e-1)/29.530588853,o=o-Math.floor(o),o<0&&(o+=1);let c=Math.floor(o*8);return J[c%8]}var y=class{constructor({data:e}){this._data=e}render(){let e=document.createElement("div");e.className="card moon-sun-card";let t=(this._data||{}).sun||{},r=I();return e.innerHTML=`
    ...
    `,e}};var E={current:{temperature:"--",condition:"Loading...",apparent_temperature:"--",wind_speed:"--",wind_bearing:"",humidity:"--",uv_index:"--"},daily:[],hourly:[],alerts:[],sun:{}},Z={storms:[],summary:{threatLevel:"none",closestStormName:"No storms",distanceToCenterMiles:null,insideCone:!1}},ee={solar_activity:"Loading...",k_index:"--",sunspot_count:"--",flare_count:"--"},S=class{constructor({panel:e,ws:a,root:t}){this._panel=e,this._ws=a,this._root=t,this._layout=null,this._weatherData=null,this._hurricaneData=null,this._spaceData=null,this._defaultCards=[{id:"atmosphere",type:"atmosphere",size:"full"},{id:"forecast",type:"forecast",size:"full"},{id:"radar",type:"radar",size:"full"},{id:"moonsun",type:"moonsun",size:"half"},{id:"nwsalerts",type:"nwsalerts",size:"half"},{id:"hurricane",type:"hurricane",size:"half"},{id:"space",type:"space",size:"half"}]}async _loadData(){if(this._ws)try{let[e,a,t]=await Promise.allSettled([this._ws.getWeather(),this._ws.getHurricanes(),this._ws.getSpaceMap()]);e.status==="fulfilled"&&(this._weatherData=e.value),a.status==="fulfilled"&&(this._hurricaneData=a.value),t.status==="fulfilled"&&(this._spaceData=t.value)}catch(e){console.warn("Dashboard data load error:",e)}}_getCards(){let e=this._panel._dashboardLayout;return e&&e.length>0?e:this._defaultCards}render(){let e=document.createElement("div");if(e.className="dashboard-view",this._panel._editMode){let r=document.createElement("div");r.className="dashboard-edit-bar",r.innerHTML=`
      ...
      `,a.appendChild(r)}let t=document.createElement("div");switch(t.className="card-content",e.type){case"atmosphere":{let r=new g({data:this._weatherData||E});t.appendChild(r.render());break}case"forecast":{let r=new w({data:this._weatherData||E});t.appendChild(r.render());break}case"radar":{let r=new b({config:this._panel._config});t.appendChild(r.render());break}case"moonsun":{let r=new y({data:this._weatherData||E});t.appendChild(r.render());break}case"nwsalerts":{let r=new _({data:this._weatherData||E});t.appendChild(r.render());break}case"hurricane":{let r=new k({data:this._hurricaneData||Z});t.appendChild(r.render());break}case"space":{let r=new C({data:this._spaceData||ee});t.appendChild(r.render());break}default:t.innerHTML=`<p class="text-muted">Unknown card: ${e.type}</p>`}return a.appendChild(t),a}_resetLayout(){this._panel._dashboardLayout=null,this._panel._editMode=!1,this._panel._scheduleRender()}_cancelEdit(){this._panel._editMode=!1,this._panel._scheduleRender()}_saveLayout(){this._panel._editMode=!1,this._panel._scheduleRender()}};var T=class{constructor({panel:e,ws:a,root:t}){this._panel=e,this._ws=a,this._root=t,this._tracker=null,this._mapInitialized=!1}async _ensureMap(){if(!this._mapInitialized){if(!document.querySelector('link[href*="leaflet"]')){let e=document.createElement("link");e.rel="stylesheet",e.href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css",document.head.appendChild(e)}window.L||await new Promise((e,a)=>{let t=document.createElement("script");t.src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js",t.onload=e,t.onerror=a,document.head.appendChild(t)}),window.HurricaneTracker||await new Promise((e,a)=>{let t=document.createElement("script");t.src="/local/home_weather/hurricane-tracker.js",t.onload=e,t.onerror=a,document.head.appendChild(t)}),this._mapInitialized=!0}}async _initMap(e){await this._ensureMap();let a=e.querySelector("#hazard-map");if(!(!a||!window.HurricaneTracker)){if(this._tracker){this._tracker.refresh();return}this._tracker=new window.HurricaneTracker({hass:this._panel.hass,shadowRoot:this._panel.shadowRoot}),await this._tracker.init(a)}}async render(){let e=document.createElement("div");return e.className="hurricanes-view",e.innerHTML=`
    ...
    `;let t=document.createElement("div");t.className="flex-1 p-4";let r=document.createElement("h2");r.style.cssText="margin:0 0 var(--space-4)",r.textContent="Settings",t.appendChild(r);let s=document.createElement("div");return s.className="settings-content",s.innerHTML=this._renderPaneContent(this._pane),t.appendChild(s),e.appendChild(a),e.appendChild(t),a.querySelectorAll(".settings-sidebar-item").forEach(i=>{i.addEventListener("click",()=>{a.querySelectorAll(".settings-sidebar-item").forEach(o=>o.classList.remove("is-active")),i.classList.add("is-active"),this._pane=i.dataset.pane,s.innerHTML=this._renderPaneContent(this._pane)})}),e}_renderPaneContent(e){switch(e){case"general-weather-source":return`
        ...
        `;default:return`<div class="card"><h3 style="margin:0">${e.replace(/-/g," ").replace(/^\w/,a=>a.toUpperCase())}</h3><p class="text-muted">Settings for ${e.replace(/-/g," ")}.</p></div>`}}};var $=class{constructor({panel:e,currentView:a,isNarrow:t,onNavigate:r}){this._panel=e,this._currentView=a,this._isNarrow=t,this._onNavigate=r}render(){let e=document.createElement("div");e.className="app-bar";let a=document.createElement("div");a.className="app-bar-brand",a.innerHTML='<span class="accent">Home</span> Weather',e.appendChild(a);let t=document.createElement("nav");t.className="app-bar-nav";let r=[{id:"forecast",label:"Forecast",icon:"\u2601"},{id:"hurricanes",label:"Hurricanes",icon:"\u{1F300}"},{id:"space",label:"Space",icon:"\u{1F680}"},{id:"alerts",label:"Alerts",icon:"\u26A0"},{id:"trends",label:"Trends",icon:"\u{1F4CA}"}];for(let o of r){let c=document.createElement("button");c.className="app-bar-nav-btn"+(o.id===this._currentView?" is-active":""),c.innerHTML=`${o.icon} ${o.label}`,c.addEventListener("click",()=>this._onNavigate(o.id)),t.appendChild(c)}e.appendChild(t);let s=document.createElement("div");s.className="app-bar-actions";let i=document.createElement("button");return i.className="btn btn-icon btn-ghost",i.innerHTML="\u2699",i.title="Settings",i.addEventListener("click",()=>this._onNavigate("settings")),s.appendChild(i),e.appendChild(s),e}};var H=class{constructor({panel:e}){this._panel=e,this._isOpen=!1,this._content=null}get isOpen(){return this._isOpen}open(e){this._content=e,this._isOpen=!0,this._render()}close(){this._isOpen=!1,this._content=null,this._render()}_render(){if(this._el&&this._el.remove(),!this._isOpen)return;let e=document.createElement("div");e.className="detail-sheet-backdrop is-open";let a=document.createElement("div");a.className="detail-sheet";let t=document.createElement("div");t.className="detail-sheet-handle",a.appendChild(t);let r=document.createElement("button");r.className="btn btn-icon btn-ghost",r.innerHTML="\xD7",r.style.cssText="position:absolute;top:var(--space-3);right:var(--space-3)",r.addEventListener("click",()=>this.close()),a.appendChild(r);let s=document.createElement("div");s.className="detail-sheet-content",typeof this._content=="string"?s.innerHTML=this._content:this._content instanceof Node&&s.appendChild(this._content),a.appendChild(s),e.appendChild(a),e.addEventListener("click",i=>{i.target===e&&this.close()}),this._el=e}renderEl(){return this._isOpen&&this._el?this._el:document.createElement("div")}render(){return this._isOpen&&this._el?this._el:document.createElement("div")}};var V=`/* Global base styles for Home Weather panel */\r
:host {\r
  display: block;\r
  width: 100%;\r
  height: 100%;\r
...
`;var K=`/* Responsive layout utilities */\r
\r
/* Container */\r
.container {\r
  width: 100%;\r
...
`;var U=`/* Dashboard and card styles */\r
\r
.dashboard-view {\r
  display: flex;\r
  flex-direction: column;\r
...
`;var ne=V+K+Q+U,v=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this._hass=null,this._panel=null,this._config={},this._currentView="forecast",this._isNarrow=!1,this._narrowOverride=null,this._ws=null,this._version=null,this._appearance={mode:"dark",overrides:{}},this._dashboardLayout=null,this._editMode=!1,this._views={},this._appBar=null,this._detailSheet=null,this._scheduleRender=B(()=>this._render(),50)}get hass(){return this._hass}set hass(e){this._hass=e,e&&!this._ws&&(this._ws=new f(e)),this._scheduleRender()}get panel(){return this._panel}set panel(e){this._panel=e,this._scheduleRender()}get _isNarrow(){return this._narrowOverride!==null?this._narrowOverride:this.__isNarrow}set _isNarrow(e){this.__isNarrow=e,this.classList.toggle("is-narrow",e),this._scheduleRender()}connectedCallback(){this._injectStyles(),this._setupMediaQuery(),this._setupKeyboard(),this._loadConfig(),this._scheduleRender()}disconnectedCallback(){this._mediaQueryCleanup&&this._mediaQueryCleanup(),this._resizeObserver&&this._resizeObserver.disconnect()}_injectStyles(){let e=document.createElement("style");e.textContent=ne,this.shadowRoot.appendChild(e)}_setupMediaQuery(){this._mediaQueryCleanup=q("(max-width: 768px)",e=>{this._isNarrow=e})}_setupKeyboard(){this.addEventListener("keydown",e=>{e.key==="Escape"&&this._detailSheet&&this._detailSheet.isOpen&&this._detailSheet.close()})}async _loadConfig(){if(this._ws)try{let e=await this._ws.getConfig();this._config=e||{},this._appearance=e.appearance||{mode:"dark",overrides:{}},this._dashboardLayout=e.dashboard_layout||null,this._applyTheme(),this._scheduleRender()}catch(e){console.warn("Failed to load config:",e)}}_applyTheme(){R(this,this._appearance.mode,this._appearance.overrides)}_navigateTo(e){this._currentView=e,this._scheduleRender()}_initView(e){if(this._views[e])return this._views[e];let a=this.shadowRoot,t=this,r;switch(e){case"forecast":r=new S({panel:t,ws:this._ws,root:a});break;case"hurricanes":r=new T({panel:t,ws:this._ws,root:a});break;case"space":r=new N({panel:t,ws:this._ws,root:a});break;case"alerts":r=new M({panel:t,ws:this._ws,root:a});break;case"trends":r=new L({panel:t,ws:this._ws,root:a});break;case"settings":r=new z({panel:t,ws:this._ws,root:a});break}return r&&(this._views[e]=r),r}_render(){let e=this.shadowRoot;P(e),this._appBar=new $({panel:this,currentView:this._currentView,isNarrow:this._isNarrow,onNavigate:s=>this._navigateTo(s)}),e.appendChild(this._appBar.render());let a=document.createElement("main");a.className="content-area";let t=this._initView(this._currentView);t?a.appendChild(t.render()):a.innerHTML='<div class="flex-center" style="height:200px"><p class="text-muted">Loading...</p></div>',e.appendChild(a),this._detailSheet=new H({panel:this}),e.appendChild(this._detailSheet.render());let r=document.createElement("div");r.className="toast-container",r.id="toast-container",e.appendChild(r)}showToast(e,a="info",t=3e3){let r=F(this.shadowRoot,"#toast-container");if(!r)return;let s=document.createElement("div");s.className=`toast ${a}`,s.textContent=e,r.appendChild(s),setTimeout(()=>{s.style.opacity="0",s.style.transform="translateX(100%)",s.style.transition="all 300ms ease",setTimeout(()=>s.remove(),300)},t)}openDetailSheet(e){this._detailSheet&&this._detailSheet.open(e)}closeDetailSheet(){this._detailSheet&&this._detailSheet.close()}async saveConfig(e){if(this._ws)try{let a={...this._config,...e};return await this._ws.setConfig(a),this._config=a,e.appearance&&(this._appearance=e.appearance,this._applyTheme()),this.showToast("Settings saved","success"),!0}catch(a){return this.showToast("Failed to save: "+a.message,"error"),!1}}};customElements.get("home-weather-panel")||customElements.define("home-weather-panel",v);window.HomeWeatherPanel=v;})();
